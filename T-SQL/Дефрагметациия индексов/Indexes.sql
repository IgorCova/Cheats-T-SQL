select
  ...
  from SQL80.autosales.sys.dm_db_missing_index_groups mig
  inner join SQL80.autosales.sys.dm_db_missing_index_group_stats migs on migs.group_handle = 
       mig.index_group_handle
  inner join SQL80.autosales.sys.dm_db_missing_index_details mid on mig.index_handle = 
       mid.index_handle
  inner join SQL80.autosales.sys.objects o on o.object_id = mid.object_id
  inner join SQL80.autosales.sys.schemas sch on sch.schema_id = o.schema_id
